...
class MqttS3MultiClientsCommManager(BaseCommunicationManager):
    def __init__(
        ...
        if args.client_id_list is not None:
            ...
            # MqttS3CommManager args client_id_list: [1, 2, 3]
            logging.info(
                "MqttS3CommManager args client_id_list: " + str(args.client_id_list)
            )
            self.client_real_ids = json.loads(args.client_id_list) # client_id_list: "[1, 2, 3]"
        ...
        # mqtt_s3.init: client_num = 3
        self.client_num = client_num
        logging.info("mqtt_s3.init: client_num = %d" % client_num)

        #set the broker_host and broker_port
        ...
        # This is subscriber/publisher instance
        ...
        # Through elf._connected_listeners pass the client to on_connected function
        # and process the message here
        ...
        self.mqtt_mgr.add_connected_listener(self.on_connected) # self._connected_listeners.append(listener)
    ...
    def on_connected(self, mqtt_client_object):
        ...
        print("comm_manager_on_connected")
        ...
        if self.client_id == 0:
            ...
            self._notify_connection_ready() # go to handle_messag_connection_ready in fedml_server_manager.py
            ...
            real_topic = self._topic + str(self.server_id) + "_" + str(self._client_id)
            result, mid = mqtt_client_object.subscribe(real_topic, 0)
